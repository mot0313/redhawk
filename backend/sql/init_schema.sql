...
SELECT pg_catalog.setval('public.alert_info_alert_id_seq', (SELECT COALESCE(MAX(alert_id), 0) FROM public.alert_info), true);
SELECT pg_catalog.setval('public.maintenance_schedule_schedule_id_seq', (SELECT COALESCE(MAX(schedule_id), 0) FROM public.maintenance_schedule), true);
SELECT pg_catalog.setval('public.sys_oper_log_oper_id_seq', (SELECT COALESCE(MAX(oper_id), 0) FROM public.sys_oper_log), true);
SELECT pg_catalog.setval('public.sys_logininfor_info_id_seq', (SELECT COALESCE(MAX(info_id), 0) FROM public.sys_logininfor), true);
SELECT pg_catalog.setval('public.sys_job_log_job_log_id_seq', (SELECT COALESCE(MAX(job_log_id), 0) FROM public.sys_job_log), true);
SELECT pg_catalog.setval('public.sys_notice_notice_id_seq', (SELECT COALESCE(MAX(notice_id), 0) FROM public.sys_notice), true);
SELECT pg_catalog.setval('public.gen_table_table_id_seq', (SELECT COALESCE(MAX(table_id), 0) FROM public.gen_table), true);
SELECT pg_catalog.setval('public.gen_table_column_column_id_seq', (SELECT COALESCE(MAX(column_id), 0) FROM public.gen_table_column), true);
